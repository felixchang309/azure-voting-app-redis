#!/bin/bash
export resourceGroup=myJenkinsGroup
virtualMachine=myJenkinsVM
adminUser=azureuser
...
then
    ...
    # Create a resource group.  eastus,westeurope,francecentral,centralus,
    # canadacentral,canadaeast,uksouth,westus,westus2,australiaeast,northeurope,
    # japaneast,eastus2,southeastasia,australiasoutheast,ukwest,southindia,eastasia
